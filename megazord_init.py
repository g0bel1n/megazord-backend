   ...
   """
    ...
    def train_zords(self, epochs=2):
        ...
        for zord in self.train_queue:
            ...
            augmented_train_ds = train_ds.map(lambda tensor, label: (self.data_augmentation(tensor), label))
...
if __name__ == "__main__":
    ...
    megazord_ = swiss_knife.assemble_megazord()

    swiss_knife.save(megazord_)

    swiss_knife.megazord_to_coreml(megazord_)
